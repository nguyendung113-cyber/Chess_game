...
namespace QuanLyCoffee
{
    public partial class frmBanHang : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)//chuyen ban
        {
            ...
            if ((ccbBan.SelectedItem as Table).Status=="Trống" && MessageBox.Show(string.Format("Bạn có thật sự muốn chuyển bàn {0} qua bàn {1}", (lsvBill.Tag as Table).Name, (ccbBan.SelectedItem as Table).Name), "Thông báo", MessageBoxButtons.OKCancel) == System.Windows.Forms.DialogResult.OK)
            {
